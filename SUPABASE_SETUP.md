...
On the first successful load, the portal inserts all bundled ARC resources and NCERT activities into `stemlab_resources` and `stemlab_manuals`. New lab sessions are stored in `stemlab_sessions`.
